...
<template>
  <header v-if="$route.path !== '/login' && $route.path !== '/admin'"  class="z-10 bg-white dark:bg-dark fixed top-0 left-0 w-[100%] px-[50px] xl:px-[20px] md:px-[10px] pt-[16px] md:pt-[10px] pb-[10px] border-b border-1 border-main dark:border-white text-xl lg:text-lg flex items-center justify-between overflow-hidden">
